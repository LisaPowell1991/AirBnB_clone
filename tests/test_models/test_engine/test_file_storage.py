...
class TestFileStorage_instantiation(unittest.TestCase):
    ...
    def testFileStorage_objects_is_private_dict(self):
        """Test if objects attribute is private"""
        self.assertEqual(dict, type(FileStorage._FileStorage__objects))

    def test_storage_initializes(self):
        """Test if FileStorage initializes"""
...
class TestFileStorage_methods(unittest.TestCase):
    ...
    def test_all(self):
        """Test if all method returns object of type dict"""
        self.assertEqual(dict, type(models.storage.all()))

    def test_all_with_arg(self):
        """Test if all method takes args"""
        with self.assertRaises(TypeError):
            models.storage.all(None)

    def test_new(self):
        """Test if new method works"""
        bm = BaseModel()
        us = User()
        st = State()
        pl = Place()
    ...
    def test_new_with_args(self):
        """Test if new method works with args"""
        with self.assertRaises(TypeError):
    ...
    def test_save_with_arg(self):
        """Test if save method handles args"""
        with self.assertRaises(TypeError):
            models.storage.save(None)

    def test_reload(self):
        """Test if reload method works"""
        bm = BaseModel()
        us = User()
        st = State()
        pl = Place()
    ...
    def test_reload_with_arg(self):
        """Test if reload works with args"""
        with self.assertRaises(TypeError):
